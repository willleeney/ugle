...
lbatch -c 1 -g 1 -m 22 -t 300 -a EMAT022967 -q gpu --conda-env UFR --cmd python3 model_evaluations.py -ec=ugle/configs/experiments/paper_configs/unsupervised_limit/sublime_synth.yaml  --gpu=0
lbatch -c 1 -g 1 -m 22 -t 300 -a EMAT022967 -q gpu --conda-env UFR --cmd python3 model_evaluations.py -ec=ugle/configs/experiments/paper_configs/unsupervised_limit/sublime_synth_sup.yaml --gpu=0
